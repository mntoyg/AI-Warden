...
| **E** | audit regression drills — 4 exploit ที่แก้ใน v1.0.1 (E1 symlink redirect รายงานเหตุ, E2 log injection ผ่าน argv, E3 mount guard, E4 dangling canary symlink) + E5 หลบการระบุตัวด้วย argv ปลอมเป็น warden (แก้ใน v1.0.4) + E6 report เก่า/ที่ agent วางไว้ต้องไม่กลืน report ของ breach ใหม่, E7 `SIGUSR1` ที่ agent ส่งเองต้องไม่ถูกรายงานว่าเป็น tripwire (แก้ใน v1.2.1) | refuse/ป้องกันทุกกรณี |
